"""
COCO dataset class labels and utilities.
"""
...
# Vehicle classes for focused detection
VEHICLE_CLASSES = {
    1: 'bicycle',
    2: 'car',
    3: 'motorcycle',
...
def is_target_class(class_id):
    """Check if class ID is in target classes (person, bicycle, car, motorcycle)."""
    return class_id in TARGET_CLASSES
